...
router.post('/interactions', (0, discord_interactions_1.verifyKeyMiddleware)(process.env.PUBLIC_KEY), rateLimit_js_1.interactionRateLimiter, interactionController_js_1.default);
